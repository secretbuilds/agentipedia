  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
        ...
        <Card className="border-neutral-800 bg-neutral-900/50">
          <CardContent>
            <p className="text-xs text-neutral-400">Hardware</p>
            <p className="text-sm text-neutral-200">{run.hardware}</p>
          </CardContent>
        </Card>
        <Card className="border-neutral-800 bg-neutral-900/50">
          <CardContent>
            <p className="text-xs text-neutral-400">Model Size</p>
            <p className="text-sm text-neutral-200">{run.model_size}</p>
          </CardContent>
        </Card>
        <Card className="border-neutral-800 bg-neutral-900/50">
          <CardContent>
            <p className="text-xs text-neutral-400">Time Budget</p>
            <p className="text-sm text-neutral-200">{run.time_budget}</p>
          </CardContent>
        </Card>
      </div>
    </div>
